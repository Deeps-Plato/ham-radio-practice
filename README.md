...
- Super Beginner Mode toggle that progressively reveals key concepts, equations, and visuals
- Per-concept visuals: each module now has its own picture and graph
- Quick knowledge-check mini quizzes on each module with instant feedback and scoring
